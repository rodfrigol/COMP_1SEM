...
fun = @(x)custoControladorCorrente(requisitos, planta, x);
otimizado = fminsearch(fun, [controlador0.K controlador0.alpha controlador0.Tl]);

controlador.K = otimizado(1)
controlador.alpha = otimizado(2)
controlador.Tl = otimizado(3)
