...
INSTANTIATE_TEST_SUITE_P(Tests50VerySmall5_6,
                         SSPTest,
                         ::testing::Values(SSP_Exp({"DD","PD","BB"},{5,6},
                                                   {"P3","P4","P5","RAND","EVOD"}
                                                   ,28)
                                            ));


INSTANTIATE_TEST_SUITE_P(TestsManySmallUpto15,
                         SSPTest,
...
INSTANTIATE_TEST_SUITE_P(TestsFewLargeUpto50,
                         SSPTest,
                         ::testing::Values(SSP_Exp({"DD","PD","BB"},{30,40,50},
...
INSTANTIATE_TEST_SUITE_P(Tests_Timed,
                         SSPTimedT,
                         ::testing::Values(SSP_Exp({"DD","PD","BB"},
                                                   {5,7,8,10,12,13,15},
